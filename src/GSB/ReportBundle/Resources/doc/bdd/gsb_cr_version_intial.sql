...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 19 Mars 2015 à 16:33
...
CREATE TABLE IF NOT EXISTS `famille` (
  ...
  `libelleFamille` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `medicament` (`id`, `depotLegal`, `nomCommercial`, `idFamille`, `composition`, `effets`, `contreIndication`, `prixEchantillon`) VALUES
...
CREATE TABLE IF NOT EXISTS `praticien` (
  ...
  `typeMedecin_id` int(11) DEFAULT '3',
  PRIMARY KEY (`id`),
...
INSERT INTO `visiteur` (`id`, `idGSB`, `nom`, `prenom`, `username`, `password`, `adresse`, `cp`, `ville`, `dateEmbauche`, `salt`, `enabled`, `username_canonical`, `email`, `email_canonical`, `roles`) VALUES
 (1, 'a131', 'Villechalane', 'Louis', 'lvillachane', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21', '74vynpg8khogowoswscww4owsoo80wg', 1, 'lvillachane', 'user1@gsb-report.dev', 'user1@gsb-report.dev', 'a:0:{}'),
 (2, 'a17', 'Andre', 'David', 'dandre', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23', '74vynpg8khogowoswscww4owsoo80wg', 1, 'dandre', 'user2@gsb-report.dev', 'user2@gsb-report.dev', 'a:0:{}'),
 (3, 'a55', 'Bedos', 'Christian', 'cbedos', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '1 rue Peranud', '46250', 'Montcuq', '1995-01-12', '74vynpg8khogowoswscww4owsoo80wg', 1, 'cbedos', 'user3@gsb-report.dev', 'user3@gsb-report.dev', 'a:0:{}'),
 (4, 'a93', 'Tusseau', 'Louis', 'ltusseau', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '22 rue des Ternes', '46123', 'Gramat', '2000-05-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'ltusseau', 'user4@gsb-report.dev', 'user4@gsb-report.dev', 'a:0:{}'),
 (5, 'b13', 'Bentot', 'Pascal', 'pbentot', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '11 allée des Cerises', '46512', 'Bessines', '1992-07-09', '74vynpg8khogowoswscww4owsoo80wg', 1, 'pbentot', 'user5@gsb-report.dev', 'user5@gsb-report.dev', 'a:0:{}'),
 (6, 'b16', 'Bioret', 'Luc', 'lbioret', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '1 Avenue gambetta', '46000', 'Cahors', '1998-05-11', '74vynpg8khogowoswscww4owsoo80wg', 'lbioret', 1, 'user6@gsb-report.dev', 'user6@gsb-report.dev', 'a:0:{}'),
 (7, 'b19', 'Bunisset', 'Francis', 'fbunisset', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '10 rue des Perles', '93100', 'Montreuil', '1987-10-21', '74vynpg8khogowoswscww4owsoo80wg', 1, 'fbunisset', 'user7@gsb-report.dev', 'user7@gsb-report.dev', 'a:0:{}'),
 (8, 'b25', 'Bunisset', 'Denise', 'dbunisset', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '23 rue Manin', '75019', 'paris', '2010-12-05', '74vynpg8khogowoswscww4owsoo80wg', 1, 'dbunisset', 'user8@gsb-report.dev', 'user8@gsb-report.dev', 'a:0:{}'),
 (9, 'b28', 'Cacheux', 'Bernard', 'bcacheux', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '114 rue Blanche', '75017', 'Paris', '2009-11-12', '74vynpg8khogowoswscww4owsoo80wg', 1, 'bcacheux', 'user9@gsb-report.dev', 'user9@gsb-report.dev', 'a:0:{}'),
 (10, 'b34', 'Cadic', 'Eric', 'ecadic', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '123 avenue de la République', '75011', 'Paris', '2008-09-23', '74vynpg8khogowoswscww4owsoo80wg', 1, 'ecadic', 'user10@gsb-report.dev', 'user10@gsb-report.dev', 'a:0:{}'),
 (11, 'b4', 'Charoze', 'Catherine', 'ccharoze', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '100 rue Petit', '75019', 'Paris', '2005-11-12', '74vynpg8khogowoswscww4owsoo80wg', 1, 'ccharoze', 'user11@gsb-report.dev', 'user11@gsb-report.dev', 'a:0:{}'),
 (12, 'b50', 'Clepkens', 'Christophe', 'cclepkens', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '12 allée des Anges', '93230', 'Romainville', '2003-08-11', '74vynpg8khogowoswscww4owsoo80wg', 1, 'cclepkens', 'user12@gsb-report.dev', 'user12@gsb-report.dev', 'a:0:{}'),
 (13, 'b59', 'Cottin', 'Vincenne', 'vcottin', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '36 rue Des Roches', '93100', 'Monteuil', '2001-11-18', '74vynpg8khogowoswscww4owsoo80wg', 1, 'vcottin', 'user13@gsb-report.dev', 'user13@gsb-report.dev', 'a:0:{}'),
 (14, 'c14', 'Daburon', 'François', 'fdaburon', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '13 rue de Chanzy', '94000', 'Créteil', '2002-02-11', '74vynpg8khogowoswscww4owsoo80wg', 1, 'fdaburon', 'user14@gsb-report.dev', 'user14@gsb-report.dev', 'a:0:{}'),
 (15, 'c3', 'De', 'Philippe', 'pde', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '13 rue Barthes', '94000', 'Créteil', '2010-12-14', '74vynpg8khogowoswscww4owsoo80wg', 1, 'pde', 'user15@gsb-report.dev', 'user15@gsb-report.dev', 'a:0:{}'),
 (16, 'c54', 'Debelle', 'Michel', 'mdebelle', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '181 avenue Barbusse', '93210', 'Rosny', '2006-11-23', '74vynpg8khogowoswscww4owsoo80wg', 1, 'mdebelle', 'user16@gsb-report.dev', 'user16@gsb-report.dev', 'a:0:{}'),
 (17, 'd13', 'Debelle', 'Jeanne', 'jdebelle', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '134 allée des Joncs', '44000', 'Nantes', '2000-05-11', '74vynpg8khogowoswscww4owsoo80wg', 1, 'jdebelle', 'user17@gsb-report.dev', 'user17@gsb-report.dev', 'a:0:{}'),
 (18, 'd51', 'Debroise', 'Michel', 'mdebroise', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '2 Bld Jourdain', '44000', 'Nantes', '2001-04-17', '74vynpg8khogowoswscww4owsoo80wg', 1, 'mdebroise', 'user18@gsb-report.dev', 'user18@gsb-report.dev', 'a:0:{}'),
 (19, 'e22', 'Desmarquest', 'Nathalie', 'ndesmarquest', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '14 Place d Arc', '45000', 'Orléans', '2005-11-12', '74vynpg8khogowoswscww4owsoo80wg', 1, 'ndesmarquest', 'user19@gsb-report.dev', 'user19@gsb-report.dev', 'a:0:{}'),
 (20, 'e24', 'Desnost', 'Pierre', 'pdesnost', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '16 avenue des Cèdres', '23200', 'Guéret', '2001-02-05', '74vynpg8khogowoswscww4owsoo80wg', 1, 'pdesnost', 'user20@gsb-report.dev', 'user20@gsb-report.dev', 'a:0:{}'),
 (21, 'e39', 'Dudouit', 'Frédéric', 'fdudouit', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '18 rue de l église', '23120', 'GrandBourg', '2000-08-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'fdudouit', 'user21@gsb-report.dev', 'user21@gsb-report.dev', 'a:0:{}'),
 (22, 'e49', 'Duncombe', 'Claude', 'cduncombe', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '19 rue de la tour', '23100', 'La souteraine', '1987-10-10', '74vynpg8khogowoswscww4owsoo80wg', 1, 'cduncombe', 'user22@gsb-report.dev', 'user22@gsb-report.dev', 'a:0:{}'),
 (23, 'e5', 'Enault-Pascreau', 'Céline', 'cenault', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '25 place de la gare', '23200', 'Gueret', '1995-09-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'cenault', 'user23@gsb-report.dev', 'user23@gsb-report.dev', 'a:0:{}'),
 (24, 'e52', 'Eynde', 'Valérie', 'veynde', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '3 Grand Place', '13015', 'Marseille', '1999-11-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'veynde', 'user24@gsb-report.dev', 'user24@gsb-report.dev', 'a:0:{}'),
 (25, 'f21', 'Finck', 'Jacques', 'jfinck', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '10 avenue du Prado', '13002', 'Marseille', '2001-11-10', '74vynpg8khogowoswscww4owsoo80wg', 1, 'jfinck', 'user25@gsb-report.dev', 'user25@gsb-report.dev', 'a:0:{}'),
 (26, 'f39', 'Frémont', 'Fernande', 'ffremont', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '4 route de la mer', '13012', 'Allauh', '1998-10-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'ffremont', 'user26@gsb-report.dev', 'user26@gsb-report.dev', 'a:0:{}'),
 (27, 'f4', 'Gest', 'Alain', 'agest', 'wQYIMpaxk+j3eEOGr4jy0iFj1FFHrqwMfgDp0/mavnpwAd2oh16OLJPSWAWLsPo7eZKawftaH4wrZzU2CcMV2A==', '30 avenue de la mer', '13025', 'Berre', '1985-11-01', '74vynpg8khogowoswscww4owsoo80wg', 1, 'agest', 'user27@gsb-report.dev', 'user27@gsb-report.dev', 'a:0:{}')	27 row(s) affected, 4 warning(s):
 1364 Field 'locked' doesn't have a default value
 1364 Field 'expired' doesn't have a default value
 1364 Field 'credentials_expired' doesn't have a default value
 1366 Incorrect integer value: 'lbioret' for column 'enabled' at row 6
 Records: 27  Duplicates: 0  Warnings: 4	0.094 sec
--
...
ALTER TABLE `medicament`
  ADD CONSTRAINT `fk_medic_famille` FOREIGN KEY (`idFamille`) REFERENCES `famille` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `rapport_visite`
  ADD CONSTRAINT `FK_RAPPORT_MEDECIN` FOREIGN KEY (`medecin_id`) REFERENCES `praticien` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_RAPPORT_VISITEUR` FOREIGN KEY (`visiteur_id`) REFERENCES `visiteur` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
